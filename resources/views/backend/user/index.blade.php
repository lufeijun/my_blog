            ...
            <div class="box box-solid">
                ...
                <div class="box-header">
                    <div class="pull-right">
                        <div class="btn-group">
                            <a href="{{ route('lufeijun.user.create') }}" class="btn btn-white tooltips"
                        ...
                        @if ($users)
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td>{{ $user['email'] }}</td>
                                    <td>
                                        <a href='{{ route("lufeijun.user.edit", ["id" => $user['id']]) }}' class='btn btn-info btn-xs'>
                                            <i class="fa fa-pencil"></i> 修改</a>
                                        <a data-href='{{ route("lufeijun.user.destroy", ["id" => $user['id']]) }}'
