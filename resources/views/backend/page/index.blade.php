            ...
            <div class="box box-solid">
                <div class="box-header">
                    <div class="pull-right">
                        <a href='{{ route("lufeijun.page.create") }}' class='btn btn-success btn-xs'>
                        ...
                        @if($pages)
                            @foreach($pages as $page)
                                <tr>
                                    ...
                                    <td>{{ $page->desc }}</td>
                                    <td>
                                        <a href='{{ route("lufeijun.page.edit", ["id" => $page->id]) }}' class='btn btn-info btn-xs'>
                                            <i class="fa fa-pencil"></i> 修改</a>
                                        <a data-href='{{ route("lufeijun.page.destroy", ["id" => $page->id]) }}'
